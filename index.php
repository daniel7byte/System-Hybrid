  ...
  <body>
    <div class="container">
      <form class="form-signin" action="<?=APP_URL?>auth/validation.php" method="post">
        ...
        <input type="text" id="inputUsuario" name="usuario" class="form-control" required autofocus>
        <label for="inputContrasenia" class="sr-only">Contraseña</label>
        <input type="password" id="inputContrasenia" name="contrasenia" class="form-control" required>
